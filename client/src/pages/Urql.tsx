...
import {
  useAuthQuery,
  useLogoutMutation,
  useLoginCutedevMutation,
} from "@generated";
// import { useLogin } from "@context/loginContext"

function Urql() {
  const [authresult, _reexecute] = useAuthQuery({
        ...
        {isLogin ? (
          <article>
            ...
            <p>
              ...
              est, aliquid porro reprehenderit nulla ratione at exercitationem
              nobis optio assumenda eaque mollitia tenetur, eius quas quia. Id,
              explicabo? Praesentium, ex!
            </p>
